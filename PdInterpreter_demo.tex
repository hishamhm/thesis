...
\\
\>[4]{}\hsindent{3}{}\<[7]%
\>[7]{}\Varid{fromList}\;[\mskip1.5mu {}\<[E]%
\\
\>[7]{}\hsindent{3}{}\<[10]%
\>[10]{}\Conid{PdAtomBox}\;{}\<[21]%
\>[21]{}(\Conid{PdFloat}\;\mathrm{0}),\mbox{\onelinecomment  0}{}\<[E]%
\\
\>[7]{}\hsindent{3}{}\<[10]%
\>[10]{}\Conid{PdObj}\;{}\<[21]%
\>[21]{}[\mskip1.5mu \Conid{PdSymbol}\;\text{\tt \char34 osc\char126 \char34},\Conid{PdFloat}\;\Varid{gSharp}\mskip1.5mu]\;\mathrm{2}\;\mathrm{1},\mbox{\onelinecomment  1}{}\<[E]%
\\
\>[7]{}\hsindent{3}{}\<[10]%
\>[10]{}\Conid{PdMsgBox}\;{}\<[21]%
\>[21]{}[\mskip1.5mu \Conid{PdCommand}\;\Conid{PdToOutlet}\;(\Varid{map}\;(\Conid{PdTAtom}\mathbin{\circ}\Conid{PdFloat})\;[\mskip1.5mu \mathrm{0.5},\mathrm{1000}\mskip1.5mu])\mskip1.5mu],\mbox{\onelinecomment  2}{}\<[E]%
\\
\>[7]{}\hsindent{3}{}\<[10]%
\>[10]{}\Conid{PdMsgBox}\;{}\<[21]%
\>[21]{}[\mskip1.5mu \Conid{PdCommand}\;\Conid{PdToOutlet}\;(\Varid{map}\;(\Conid{PdTAtom}\mathbin{\circ}\Conid{PdFloat})\;[\mskip1.5mu \mathrm{0},\mathrm{100}\mskip1.5mu])\mskip1.5mu],\mbox{\onelinecomment  3}{}\<[E]%
\\
\>[7]{}\hsindent{3}{}\<[10]%
\>[10]{}\Conid{PdObj}\;{}\<[21]%
\>[21]{}[\mskip1.5mu \Conid{PdSymbol}\;\text{\tt \char34 line\char126 \char34}\mskip1.5mu]\;\mathrm{2}\;\mathrm{1},\mbox{\onelinecomment  4}{}\<[E]%
\\
\>[7]{}\hsindent{3}{}\<[10]%
\>[10]{}\Conid{PdObj}\;{}\<[21]%
\>[21]{}[\mskip1.5mu \Conid{PdSymbol}\;\text{\tt \char34 *\char126 \char34}\mskip1.5mu]\;\mathrm{2}\;\mathrm{1},\mbox{\onelinecomment  5}{}\<[E]%
\\
\>[7]{}\hsindent{3}{}\<[10]%
\>[10]{}\Conid{PdObj}\;{}\<[21]%
\>[21]{}[\mskip1.5mu \Conid{PdSymbol}\;\text{\tt \char34 dac\char126 \char34}\mskip1.5mu]\;\mathrm{1}\;\mathrm{0},\mbox{\onelinecomment  6}{}\<[E]%
\\[\blanklineskip]%
\>[7]{}\hsindent{3}{}\<[10]%
\>[10]{}\Conid{PdObj}\;{}\<[21]%
\>[21]{}[\mskip1.5mu \Conid{PdSymbol}\;\text{\tt \char34 receive\char34},\Conid{PdSymbol}\;\text{\tt \char34 MyMetro\char34}\mskip1.5mu]\;\mathrm{0}\;\mathrm{1},\mbox{\onelinecomment  7}{}\<[E]%
\\
\>[7]{}\hsindent{3}{}\<[10]%
\>[10]{}\Conid{PdObj}\;{}\<[21]%
\>[21]{}[\mskip1.5mu \Conid{PdSymbol}\;\text{\tt \char34 metro\char34},\Conid{PdFloat}\;\mathrm{500}\mskip1.5mu]\;\mathrm{2}\;\mathrm{1},\mbox{\onelinecomment  8}{}\<[E]%
\\
\>[7]{}\hsindent{3}{}\<[10]%
\>[10]{}\Conid{PdObj}\;{}\<[21]%
\>[21]{}[\mskip1.5mu \Conid{PdSymbol}\;\text{\tt \char34 delay\char34},\Conid{PdFloat}\;\mathrm{5}\mskip1.5mu]\;\mathrm{2}\;\mathrm{1},\mbox{\onelinecomment  9}{}\<[E]%
\\
\>[7]{}\hsindent{3}{}\<[10]%
\>[10]{}\Conid{PdObj}\;{}\<[21]%
\>[21]{}[\mskip1.5mu \Conid{PdSymbol}\;\text{\tt \char34 list\char34},\Conid{PdFloat}\;\mathrm{0.5},\Conid{PdFloat}\;\mathrm{0.1}\mskip1.5mu]\;\mathrm{2}\;\mathrm{1},\mbox{\onelinecomment  10}{}\<[E]%
\\
\>[7]{}\hsindent{3}{}\<[10]%
\>[10]{}\Conid{PdObj}\;{}\<[21]%
\>[21]{}[\mskip1.5mu \Conid{PdSymbol}\;\text{\tt \char34 list\char34},\Conid{PdFloat}\;\mathrm{0},\Conid{PdFloat}\;\mathrm{500}\mskip1.5mu]\;\mathrm{2}\;\mathrm{1},\mbox{\onelinecomment  11}{}\<[E]%
\\
\>[7]{}\hsindent{3}{}\<[10]%
\>[10]{}\Conid{PdObj}\;{}\<[21]%
\>[21]{}[\mskip1.5mu \Conid{PdSymbol}\;\text{\tt \char34 line\char126 \char34}\mskip1.5mu]\;\mathrm{1}\;\mathrm{1},\mbox{\onelinecomment  12}{}\<[E]%
\\
\>[7]{}\hsindent{3}{}\<[10]%
\>[10]{}\Conid{PdObj}\;{}\<[21]%
\>[21]{}[\mskip1.5mu \Conid{PdSymbol}\;\text{\tt \char34 osc\char126 \char34},\Conid{PdFloat}\;(\Varid{gSharp}\mathbin{/}\mathrm{2})\mskip1.5mu]\;\mathrm{1}\;\mathrm{1},\mbox{\onelinecomment  13}{}\<[E]%
\\
\>[7]{}\hsindent{3}{}\<[10]%
\>[10]{}\Conid{PdObj}\;{}\<[21]%
\>[21]{}[\mskip1.5mu \Conid{PdSymbol}\;\text{\tt \char34 *\char126 \char34}\mskip1.5mu]\;\mathrm{2}\;\mathrm{1},\mbox{\onelinecomment  14}{}\<[E]%
\\[\blanklineskip]%
\>[7]{}\hsindent{3}{}\<[10]%
\>[10]{}\Conid{PdMsgBox}\;{}\<[21]%
\>[21]{}[\mskip1.5mu \Conid{PdCommand}\;\Conid{PdToOutlet}\;{}\<[E]%
\\
\>[21]{}\hsindent{6}{}\<[27]%
\>[27]{}[\mskip1.5mu \Conid{PdTAtom}\;(\Conid{PdSymbol}\;\text{\tt \char34 list\char34}),\Conid{PdTAtom}\;(\Conid{PdSymbol}\;\text{\tt \char34 bang\char34})\mskip1.5mu]\mskip1.5mu],\mbox{\onelinecomment  15}{}\<[E]%
\\
\>[7]{}\hsindent{3}{}\<[10]%
\>[10]{}\Conid{PdMsgBox}\;{}\<[21]%
\>[21]{}[\mskip1.5mu \Conid{PdCommand}\;\Conid{PdToOutlet}\;{}\<[E]%
\\
\>[21]{}\hsindent{6}{}\<[27]%
\>[27]{}[\mskip1.5mu \Conid{PdTAtom}\;(\Conid{PdSymbol}\;\text{\tt \char34 list\char34}),\Conid{PdTAtom}\;(\Conid{PdSymbol}\;\text{\tt \char34 stop\char34})\mskip1.5mu]\mskip1.5mu],\mbox{\onelinecomment  16}{}\<[E]%
\\
\>[7]{}\hsindent{3}{}\<[10]%
\>[10]{}\Conid{PdMsgBox}\;{}\<[21]%
\>[21]{}[\mskip1.5mu \Conid{PdCommand}\;(\Conid{PdReceiver}\;\text{\tt \char34 MyMetro\char34})\;[\mskip1.5mu \Conid{PdTDollar}\;\mathrm{1}\mskip1.5mu]\mskip1.5mu]\mskip1.5mu]\mbox{\onelinecomment  17}{}\<[E]%
\\[\blanklineskip]%
\>[4]{}\hsindent{3}{}\<[7]%
\>[7]{})\;(\Varid{fromList}\;[\mskip1.5mu {}\<[E]%
\\
\>[7]{}\hsindent{3}{}\<[10]%
\>[10]{}((\mathrm{0},{}\<[29]%
\>[29]{}\mathrm{0})\rhd (\mathrm{1},{}\<[38]%
\>[38]{}\mathrm{0})),{}\<[43]%
\>[43]{}((\mathrm{1},{}\<[62]%
\>[62]{}\mathrm{0})\rhd (\mathrm{5},{}\<[71]%
\>[71]{}\mathrm{0})),{}\<[76]%
\>[76]{}((\mathrm{2},{}\<[95]%
\>[95]{}\mathrm{0})\rhd (\mathrm{4},{}\<[104]%
\>[104]{}\mathrm{0})),{}\<[E]%
\\
\>[7]{}\hsindent{3}{}\<[10]%
\>[10]{}((\mathrm{3},{}\<[29]%
\>[29]{}\mathrm{0})\rhd (\mathrm{4},{}\<[38]%
\>[38]{}\mathrm{0})),{}\<[43]%
\>[43]{}((\mathrm{4},{}\<[62]%
\>[62]{}\mathrm{0})\rhd (\mathrm{5},{}\<[71]%
\>[71]{}\mathrm{1})),{}\<[76]%
\>[76]{}((\mathrm{5},{}\<[95]%
\>[95]{}\mathrm{0})\rhd (\mathrm{6},{}\<[104]%
\>[104]{}\mathrm{0})),{}\<[E]%
\\
\>[7]{}\hsindent{3}{}\<[10]%
\>[10]{}((\mathrm{7},{}\<[29]%
\>[29]{}\mathrm{0})\rhd (\mathrm{8},{}\<[38]%
\>[38]{}\mathrm{0})),{}\<[43]%
\>[43]{}((\mathrm{8},{}\<[62]%
\>[62]{}\mathrm{0})\rhd (\mathrm{9},{}\<[71]%
\>[71]{}\mathrm{0})),{}\<[76]%
\>[76]{}((\mathrm{8},{}\<[95]%
\>[95]{}\mathrm{0})\rhd (\mathrm{10},{}\<[104]%
\>[104]{}\mathrm{0})),{}\<[E]%
\\
\>[7]{}\hsindent{3}{}\<[10]%
\>[10]{}((\mathrm{9},{}\<[29]%
\>[29]{}\mathrm{0})\rhd (\mathrm{11},{}\<[38]%
\>[38]{}\mathrm{0})),{}\<[43]%
\>[43]{}((\mathrm{10},{}\<[62]%
\>[62]{}\mathrm{0})\rhd (\mathrm{12},{}\<[71]%
\>[71]{}\mathrm{0})),{}\<[76]%
\>[76]{}((\mathrm{11},{}\<[95]%
\>[95]{}\mathrm{0})\rhd (\mathrm{12},{}\<[104]%
\>[104]{}\mathrm{0})),{}\<[E]%
\\
\>[7]{}\hsindent{3}{}\<[10]%
\>[10]{}((\mathrm{12},{}\<[29]%
\>[29]{}\mathrm{0})\rhd (\mathrm{14},{}\<[38]%
\>[38]{}\mathrm{0})),{}\<[43]%
\>[43]{}((\mathrm{13},{}\<[62]%
\>[62]{}\mathrm{0})\rhd (\mathrm{14},{}\<[71]%
\>[71]{}\mathrm{1})),{}\<[76]%
\>[76]{}((\mathrm{14},{}\<[95]%
\>[95]{}\mathrm{0})\rhd (\mathrm{6},{}\<[104]%
\>[104]{}\mathrm{0})),{}\<[E]%
...
\>[7]{}\hsindent{3}{}\<[10]%
\>[10]{}((\mathrm{15},{}\<[29]%
\>[29]{}\mathrm{0})\rhd (\mathrm{17},{}\<[38]%
\>[38]{}\mathrm{0})),{}\<[43]%
\>[43]{}((\mathrm{16},{}\<[62]%
\>[62]{}\mathrm{0})\rhd (\mathrm{17},{}\<[71]%
\>[71]{}\mathrm{0}))\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
\>[7]{}\hsindent{3}{}\<[10]%
\>[10]{})\;[\mskip1.5mu \mathrm{1},\mathrm{4},\mathrm{5},\mathrm{12},\mathrm{13},\mathrm{14},\mathrm{6}\mskip1.5mu]{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
