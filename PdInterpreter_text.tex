...
\\
\>[7]{}\hsindent{3}{}\<[10]%
\>[10]{}(\Varid{sort}\;(evs_{next}\plus \Varid{absTime}\;(\Varid{sSched}\;\Varid{s'})\;\Varid{step}),\Varid{s'}\mathbin{:}\Varid{states}){}\<[E]%
\\
\>[7]{}\hsindent{3}{}\<[10]%
\>[10]{}\mathbf{where}{}\<[E]%
\\
\>[10]{}\hsindent{3}{}\<[13]%
\>[13]{}(evs_{curr},evs_{next})\mathrel{=}\Varid{span}\;(\lambda (\Conid{PdEvent}\;\Varid{ts}\;\anonymous \;\anonymous )\to \Varid{ts}\equiv \Varid{step})\;\Varid{events}{}\<[E]%
\\
\>[10]{}\hsindent{3}{}\<[13]%
\>[13]{}\Varid{s'}\mathrel{=}\Varid{runStep}\;\Varid{p}\;(\Varid{s}\;\{\mskip1.5mu \Varid{sSched}\mathrel{=}[\mskip1.5mu \mskip1.5mu]\mskip1.5mu\})\;evs_{curr}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[7]{}\hsindent{3}{}\<[10]%
\>[10]{}\Varid{printOut}\;[\mskip1.5mu \Conid{PdSymbol}\;\text{\tt \char34 \$1:~symbol~needed~as~msg~destination\char34}\mskip1.5mu]\;\Varid{s'}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[4]{}\hsindent{3}{}\<[7]%
\>[7]{}\Varid{dspSort}\mathrel{=}\Varid{pDspSort}\;\Varid{p}{}\<[E]%
\\
\>[4]{}\hsindent{3}{}\<[7]%
\>[7]{}\Varid{nss'}\mathrel{=}\Varid{foldl'}\;\Varid{handle}\;(\Varid{zeroDspInlets}\;(\Varid{sNStates}\;\Varid{s})\;\Varid{dspSort})\;\Varid{dspSort}{}\<[E]%
\\[\blanklineskip]%
\>[4]{}\hsindent{3}{}\<[7]%
...
\\
\>[10]{}\hsindent{3}{}\<[13]%
\>[13]{}\Varid{propagate}\mathbin{::}{}\<[27]%
\>[27]{}[\mskip1.5mu [\mskip1.5mu \Conid{PdAtom}\mskip1.5mu]\mskip1.5mu]\to (\Conid{Seq}\;\Conid{PdNodeState})\to (\cdot \rhd \cdot ){}\<[E]%
\\
\>[27]{}\to (\Conid{Seq}\;\Conid{PdNodeState}){}\<[E]%
\\
\>[10]{}\hsindent{3}{}\<[13]%
...
\column{16}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{addToInlet}\mathbin{::}{}\<[16]%
\>[16]{}(\Conid{Int},\Conid{Int})\to [\mskip1.5mu \Conid{PdAtom}\mskip1.5mu]\to (\Conid{Seq}\;\Conid{PdNodeState}){}\<[E]%
\\
\>[16]{}\to (\Conid{Seq}\;\Conid{PdNodeState}){}\<[E]%
\\
...
\subsubsection{An object with side-effects: \texttt{print}\label{pdinterpreterprint}}
...
\column{17}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{sendMsg}\;(\Conid{PdObj}\;{}\<[17]%
\>[17]{}[\mskip1.5mu \Conid{PdSymbol}\;\text{\tt \char34 delay\char34},\Conid{PdFloat}\;\Varid{time}\mskip1.5mu]\;\Varid{inl}\;\anonymous )\;{}\<[E]%
\\
\>[17]{}[\mskip1.5mu \Conid{PdSymbol}\;\text{\tt \char34 bang\char34}\mskip1.5mu]\;\mathrm{0}\;\Varid{ns}\mathrel{=}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
...
\\
\>[4]{}\hsindent{3}{}\<[7]%
\>[7]{}(\Varid{ns'},[\mskip1.5mu \mskip1.5mu],{}\<[18]%
\>[18]{}[\mskip1.5mu [\mskip1.5mu \Conid{PdSymbol}\;\text{\tt \char34 bang\char34}\mskip1.5mu]\mskip1.5mu],{}\<[E]%
\\
\>[18]{}[\mskip1.5mu \Conid{PdEvent}\;(\Varid{floor}\;\Varid{time})\;\mathrm{0}\;[\mskip1.5mu \Conid{PdSymbol}\;\text{\tt \char34 tick\char34}\mskip1.5mu]\mskip1.5mu]){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{sendMsg}\;{}\<[10]%
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{sendMsg}\;{}\<[10]%
\>[10]{}(\Conid{PdObj}\;(\Conid{PdSymbol}\;\text{\tt \char34 osc\char126 \char34}\mathbin{:}\anonymous )\;\anonymous \;\anonymous )\;{}\<[E]%
\\
\>[10]{}\hsindent{4}{}\<[14]%
\>[14]{}[\mskip1.5mu \Conid{PdSymbol}\;\text{\tt \char34 float\char34},\Conid{PdFloat}\;\Varid{freq}\mskip1.5mu]\;\mathrm{0}\;{}\<[E]%
\\
\>[10]{}\hsindent{4}{}\<[14]%
...
\>[7]{}\hsindent{3}{}\<[10]%
\>[10]{}[\mskip1.5mu {}\<[13]%
\>[13]{}\Conid{PdFloat}\;\Varid{current},{}\<[E]%
\\
\>[13]{}\Conid{PdFloat}\;\Varid{amp},{}\<[E]%
\\
\>[13]{}\Conid{PdFloat}\;((\Varid{amp}\mathbin{-}\Varid{current})\mathbin{/}(\Varid{time}\mathbin{*}\mathrm{32}))\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\mathbf{in}{}\<[E]%
\\
...
\>[13]{}\Varid{obj}\mathord{@}(\Conid{PdObj}\;[\mskip1.5mu \Conid{PdSymbol}\;\text{\tt \char34 osc\char126 \char34},\Conid{PdFloat}\;\Varid{freq}\mskip1.5mu]\;\anonymous \;\anonymous ){}\<[E]%
\\
\>[13]{}(\Conid{PdNodeState}\;\Varid{ins}\;[\mskip1.5mu \mskip1.5mu])\mathrel{=}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\mathbf{let}{}\<[E]%
\\
\>[4]{}\hsindent{3}{}\<[7]%
\>[7]{}\Varid{values}\mathrel{=}[\mskip1.5mu \Conid{PdFloat}\;((\mathrm{2}\mathbin{*}\Varid{pi})\mathbin{/}(\mathrm{32000}\mathbin{/}\Varid{freq})),\Conid{PdFloat}\;\mathrm{0}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\mathbf{in}{}\<[E]%
\\
\>[4]{}\hsindent{3}{}\<[7]%
\>[7]{}\Varid{performDsp}\;\Varid{obj}\;(\Conid{PdNodeState}\;\Varid{ins}\;\Varid{values}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{performDsp}\;{}\<[13]%
