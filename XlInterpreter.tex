...
interested reader. The source code in \text{\tt \char46{}lhs} format (\LaTeX~with embedded
...
\\
\>[B]{}\mathbf{import}\;\Conid{\Conid{Data}.\Conid{Map}.Strict}\;\Varid{as}\;\Conid{Map}\;(\Conid{Map},\Varid{foldlWithKey},\Varid{member},\Varid{insert},\Varid{empty},\Varid{lookup}){}\<[E]%
\\
\>[B]{}\mathbf{import}\;\Conid{\Conid{Data}.Set}\;\Varid{as}\;\Conid{Set}\;(\Conid{Set},\Varid{insert},\Varid{member},\Varid{singleton}){}\<[E]%
\\
...
\\
\>[10]{}\hsindent{3}{}\<[13]%
\>[13]{}\mathbf{in}\;\Varid{\Conid{Map}.insert}\;\Varid{rc}\;\Varid{v'}\;\Varid{vs'}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\mathbf{in}{}\<[E]%
\\
...
\column{37}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{updateCells}\;\Varid{cells}\;\Varid{event}\mathord{@}(\Conid{XlSetFormula}\;\Varid{rc}\;\Varid{formula})\mathrel{=}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{\Conid{Map}.insert}\;\Varid{rc}\;(\Conid{XlCell}\;\Varid{formula})\;\Varid{cells}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{updateCells}\;\Varid{cells}\;\Varid{event}\mathord{@}(\Conid{XlSetArrayFormula}\;rc_{from}\;rc_{to}\;\Varid{formula})\mathrel{=}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
...
\>[37]{}\mathrel{=}(\Varid{\Conid{Map}.insert}\;\Varid{rc}\;(\Conid{XlAFCell}\;\Varid{formula}\;(\Varid{x},\Varid{y}))\;\Varid{cells},(\Varid{x}\mathbin{+}\mathrm{1},\Varid{y})){}\<[E]%
\\
\>[7]{}\hsindent{3}{}\<[10]%
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{calcCell}\mathbin{::}\Conid{Set}\;\llparenthesis \cdot , \cdot \rrparenthesis \to \Conid{XlCells}\to \Conid{XlValues}\to \llparenthesis \cdot , \cdot \rrparenthesis \to \Conid{XlCell}\to (\Conid{XlValue},\Conid{XlValues}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[4]{}\hsindent{3}{}\<[7]%
\>[7]{}\Varid{displayRule}\mathbin{::}\Conid{Int}\to \Conid{Int}\to \Conid{Int}\to \Conid{Int}\to (\Conid{Int}\to \Conid{Int}\to \Conid{XlFormula})\to \Conid{XlFormula}{}\<[E]%
\\
\>[4]{}\hsindent{3}{}\<[7]%
...
\\
\>[4]{}\hsindent{3}{}\<[7]%
\>[7]{}\mathbf{if}\;\Varid{ref}\in(\Varid{eVisiting}\;\Varid{ev}){}\<[E]%
\\
\>[4]{}\hsindent{3}{}\<[7]%
...
\\
\>[10]{}\hsindent{3}{}\<[13]%
\>[13]{}\mathbf{case}\;\Varid{\Conid{Map}.lookup}\;\Varid{ref}\;(\Varid{eCells}\;\Varid{ev})\;\mathbf{of}{}\<[E]%
\\
\>[10]{}\hsindent{3}{}\<[13]%
\>[13]{}\Conid{Nothing}{}\<[24]%
...
\\
\>[16]{}\hsindent{3}{}\<[19]%
\>[19]{}(\Varid{v'},\Varid{vs'})\mathrel{=}\Varid{calcCell}\;(\Varid{\Conid{Set}.insert}\;\Varid{ref}\;(\Varid{eVisiting}\;\Varid{ev}))\;(\Varid{eCells}\;\Varid{ev})\;\Varid{vs}\;\Varid{ref}\;\Varid{cell}{}\<[E]%
\\
\>[16]{}\hsindent{3}{}\<[19]%
\>[19]{}\Varid{vs''}\mathrel{=}\Varid{\Conid{Map}.insert}\;\Varid{ref}\;\Varid{v'}\;\Varid{vs'}{}\<[E]%
\\
\>[13]{}\hsindent{3}{}\<[16]%
\>[16]{}\mathbf{in}{}\<[E]%
\\
\>[16]{}\hsindent{3}{}\<[19]%
\>[19]{}(\Varid{v'},\Varid{vs''}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\[\blanklineskip]%
\>[10]{}\hsindent{3}{}\<[13]%
\>[13]{}op_{row}\mathbin{::}([\mskip1.5mu [\mskip1.5mu \Conid{XlValue}\mskip1.5mu]\mskip1.5mu],\Conid{XlValues})\to \Conid{Int}\to ([\mskip1.5mu \Conid{XlValue}\mskip1.5mu],\Conid{XlValues})\to ([\mskip1.5mu [\mskip1.5mu \Conid{XlValue}\mskip1.5mu]\mskip1.5mu],\Conid{XlValues}){}\<[E]%
\\
\>[10]{}\hsindent{3}{}\<[13]%
...
\>[11]{}(\Conid{Double}\to \Conid{Double}\to \Conid{Double}){}\<[E]%
\\
\>[11]{}\to \Conid{XlEvaluator}\to \Conid{XlValues}\to \Conid{XlFormula}\to \Conid{XlFormula}\to (\Conid{XlValue},\Conid{XlValues}){}\<[E]%
\\
...
OpenDocument specification for the \text{\tt \char46{}ods} format [***reference***] and the ISO
Open Office XML specification for the \text{\tt \char46{}xlsx} format [***reference***], as
